...
export const Contacto = () => {
    ...
    const enviarConsulta = (e) => {
        ...
        //fetch(`http://localhost:8080/api/contacto/guardar`,
        fetch(API_ENDPOINTS.contacto + '/guardar',
            {
                method: "post",
    ...
    const borrarCampos = (e) => {
        setMensajeContacto(getDefaultMensajeContacto());
    }

    return (
        <>
            <title>{`Contacto | Yoga en equilibrio`}</title>
            <meta name="description" content="¿Tienes preguntas? Contáctanos a través de nuestro formulario de atención."></meta>
